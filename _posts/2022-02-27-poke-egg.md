...
<div>
    <div>父代V项：<span><py-inputbox id="father-v"></py-inputbox></span>(HABCDS可选)</div>
    <div>母代V数：<span><py-inputbox id="mother-v"></py-inputbox></span>(0~5可选)</div>
    <div>子代V数：<span><py-inputbox id="child-v"></py-inputbox></span>(0~5可选)</div>
    <div>雌雄比：<span><py-inputbox id="male-rate"></py-inputbox></span>(0~1可选)</div>
    <button id="calc-btn" pys-onClick="buttonClick">execute</button>
    <p id="calc-res"></p>
</div>
