...
layout: post
title: 可复用强密码生成器
permalink: /projects/可复用强密码生成器.html
---
...
<div class="img-frame"><img src="/assets/src/password-gen/table.png"></div>
...
<head><script defer src="https://pyscript.net/alpha/pyscript.js"></script></head>
<py-script src="/assets/src/password-gen/password-gen.py"></py-script>
<py-script>
...
<div>
    <div>主信息：<span><py-inputbox id="main-info"></py-inputbox></span></div>
    <div>副信息：<span><py-inputbox id="sub-info"></py-inputbox></span></div>
    <div>密码长度：<span><py-inputbox id="pass-len"></py-inputbox></span>(4~32可选)</div>
    <div>密码构成：
    ...
    <button id="gen-btn" pys-onClick="buttonClick">execute</button>
    <p id="gen-res"></p>
</div>
